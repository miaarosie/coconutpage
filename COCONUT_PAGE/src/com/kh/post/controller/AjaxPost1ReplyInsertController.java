...
/**
 * Servlet implementation class AjaxPost1ReplyInsertController
 */
@WebServlet("/walgeRinsert.po")
public class AjaxPost1ReplyInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPost1ReplyInsertController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (emp == null) {
			...
			int result = new Post1Service().insertReply(r);
