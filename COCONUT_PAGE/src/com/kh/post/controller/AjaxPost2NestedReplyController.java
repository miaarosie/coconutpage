...
/**
 * Servlet implementation class AjaxPost2NestedReplyController
 */
@WebServlet("/thnrinsert.po")
public class AjaxPost2NestedReplyController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPost2NestedReplyController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (emp == null) {
			...
			int result = new Post2Service().insertNestedReply(r);
