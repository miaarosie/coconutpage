...
/**
 * Servlet implementation class Post2UpdateController
 */
@WebServlet("/thingsUpdate.po")
public class Post2UpdateController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Post2UpdateController() {
        super();
		...
		if (emp == null) {
			...
			if(ServletFileUpload.isMultipartContent(request)) {
				...
				if(multiRequest.getOriginalFileName("reUpfile") != null) {
				 ...
				 int result = new Post2Service().updatePost2(p, pf);
				 if(result>0) {
					 ...
					 response.sendRedirect(request.getContextPath()+ "/thingsDetail.po?pno="+postNo);
				 } else {
