...
/**
 * Servlet implementation class AjaxPost1LikeInsertController
 */
@WebServlet("/waglelinsert.po")
public class AjaxPost1LikeInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPost1LikeInsertController() {
        super();
