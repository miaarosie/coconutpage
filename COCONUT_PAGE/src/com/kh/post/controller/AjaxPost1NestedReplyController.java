...
/**
 * Servlet implementation class AjaxPost1NestedReplyController
 */
@WebServlet("/wagleNRinsert.po")
public class AjaxPost1NestedReplyController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPost1NestedReplyController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (emp == null) {
			...
			int result = new Post1Service().insertNestedReply(r);
