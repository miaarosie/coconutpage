...
/**
 * Servlet implementation class AjaxPost2LikeDeleteController
 */
@WebServlet("/wagleldelete.po")
public class AjaxPost1LikeDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPost1LikeDeleteController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (emp == null) {
			...
			int result = new Post2Service().deleteLike(l);
