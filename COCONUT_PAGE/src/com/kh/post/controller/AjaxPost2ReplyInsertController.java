...
/**
 * Servlet implementation class AjaxPost2ReplyInsertController
 */
@WebServlet("/thrinsert.po")
public class AjaxPost2ReplyInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPost2ReplyInsertController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (emp == null) {
			...
			int result = new Post2Service().insertReply(r);
