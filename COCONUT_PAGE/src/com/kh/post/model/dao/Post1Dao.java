...
public class Post1Dao {

	private Properties prop = new Properties();
	
	public Post1Dao() {
		String fileName = Post1Dao.class.getResource("/sql/post/post1-mapper.xml").getPath();
		try {
	...
	public ArrayList<Post1> selectList(Connection conn, PageInfo pi) {
		ArrayList<Post1> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		try {
			...
			while(rset.next()) {
				list.add(new Post1(rset.getInt("POST_NO")
	...
	public ArrayList<Post1> selectList(Connection conn, PageInfo pi, String keyword, String searchword) {
		ArrayList<Post1> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
	...
	public Post1 selectPost1(Connection conn, int postNo) {
		Post1 p = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		
		String sql = prop.getProperty("selectPost1");
		...
		try {
			...
			if(rset.next()) {
				p = new Post1(rset.getInt("POST_NO")
						    , rset.getString("POST_TITLE")
	...
	public Post1File selectPost1File(Connection conn, int postNo) {
		
		Post1File pf = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		
		String sql = prop.getProperty("selectPost1File");
	...
	public int insertPost1(Connection conn , Post1 p) {
		
		int result = 0;
		
		PreparedStatement pstmt = null;
		String sql = prop.getProperty("insertPost1");
	...
	public int insertPost1File(Connection conn, Post1File pf) {
		
		int result = 0;
		PreparedStatement pstmt = null;
		String sql = prop.getProperty("insertPost1File");
	...
	public int updatePost1(Connection conn, Post1 p ) {
		
		int result = 0;
		PreparedStatement pstmt = null;
		
		String sql = prop.getProperty("updatePost1");
	...
	public int updatePost1File(Connection conn, Post1File pf) {
		
		int result = 0;
		PreparedStatement pstmt = null;
		String sql = prop.getProperty("updatePost1File");
	...
	public int insertNewPost1File(Connection conn, Post1File pf) {
		
		int result = 0;
		
		PreparedStatement pstmt = null;
		String sql = prop.getProperty("insertNewPost1File");
	...
	public int deletePost1File(Connection conn, int fileNo) {
		int result = 0;
		PreparedStatement pstmt = null;
		String sql = prop.getProperty("deletePost1File");
	...
	public int deletePost1(Connection conn, int postNo) {
		int result = 0;
		PreparedStatement pstmt = null;
		String sql = prop.getProperty("deletePost1");
