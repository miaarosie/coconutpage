...
public class Post2 {
	...
	public Post2(int postNo, int postType, String postTitle, String postContent, Date regDate, int viewCount,
	...
	// 리스트 조회용 생성자부
	public Post2(int postNo, String postTitle, String empNo, Date regDate) {
		super();
		this.postNo = postNo;
		this.postTitle = postTitle; 
		this.empNo = empNo;
	...
	// 게시글 상세조회용 생성자부
	public Post2(int postNo, String postTitle, String deptName, String empNo,  Date regDate, int viewCount, String postContent) {
		super();
		this.postNo = postNo;
		this.postTitle = postTitle;
	...
	public String toString() {
		return "Post2 [postNo=" + postNo + ", postType=" + postType + ", postTitle=" + postTitle + ", postContent="
