...
/**
 * Servlet implementation class TempSaveExpenseFormController
 */
@WebServlet("/spentForm.ts")
public class TempSaveExpenseFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TempSaveExpenseFormController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (emp == null) {
			...
			if (ServletFileUpload.isMultipartContent(request)) {
				...
				// HttpServlerRequest => MultipartRequest
				...
				// 값 뽑기
	//			String edate = multiRequest.getParameter("enrollDate"); // 신청일자
...
//				
	...
	//			a.setUpdateDate(enrollDate);
				...
				// 서비스 요청
				// int result = new ApprovalService().insertTempAppDoc(a, dclist, apList, refList);
				
				// 서비스 요청
				int result = new ApprovalService().insertTempAppDoc(a, dclist);
