...
<%
	...
	ArrayList<DocSpent> dsl = (ArrayList<DocSpent>)request.getAttribute("dsl");
                    ...
                    <div id="main-left">
                     <div id="apr_btn_dv">
                      ...
                      <% if(aprState == 1) { %>
                        ...
                        <table class="table" id="docspent_view_tb">
                            <tr>
                                <th>신청일자 / <br> 신청자</th>
                                <td>
                        ...
                        <% int sum = 0;   
                              ...
                              for(DocSpent ds : dsl) { 
                             		sum+=ds.getSpentMoney();
                              } 
                              String str = numberFormat.format(sum);		%>	
                            ...
                            <tr style="height: 150px;">
                                <th>비고</th>
                                <td><%=a.getAprContent() %></td>
                            </tr>
                            <tr style="height: 400px;">
                                <th>내역</th>
                                <td>                                    
                                    <div id="docspent_dv">
                                        <table class="table" id="spent-tb">
                                            <thead>
                                        	    <tr>
	                                        	    <th>순번</th>
	                                   				<th>사용일자</th>
                                        ...
                                        <% 	int count = 1; 
                                        	...
                                        	for(DocSpent ds : dsl) { 
                                        	      str = numberFormat.format(ds.getSpentMoney());	%>
                                        	    <tr>
                                        		<td><%=count %></td>
                                   				<td><%=ds.getSpentDate() %></td>
                                                <td><%=ds.getHistory() %></td>
                                                <td><%=ds.getCorpName() %></td>
                                                <td><%=ds.getCorpNo() %></td>
                                                <td><%=str %></td>
                                                </tr>
                                        <%  count++;
