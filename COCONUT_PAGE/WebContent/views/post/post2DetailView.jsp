		...
		<div class="container">
			...
			<div class="main">
				<div id="thingsdetail">
                    ...
                    <div class="upper">
                        <input type="button" value="목록" class="btn-man" onclick="location.href='<%= contextPath %>/thingsList.po?currentPage=1';" style="float : left">
	                    <% if(e.getEmpName().equals(p.getEmpNo()) || e.getManagerYN().equals("Y")) { %>
		                    <a href="<%= contextPath %>/thingsUpdateForm.po?pno=<%=p.getPostNo() %>" class="btn-man" style="float : right">수정</a>
                    ...
                    <table class="contentarea" style="text-align : center;"> 
                    	<tr>
	                    	<th><textarea id="things_content" style="resize:none;" disabled readonly><%= p.getPostContent() %></textarea><th>
	                    </tr>
                        <tr>
                            <th>
                                <% if(pf != null) {%>
                                    <img src="<%=contextPath%>/<%= pf.getFilePath() + pf.getChangeName() %>" align="center" width="400px" height="550px" >
                                <% } %>
                            </th>
                        </tr>
                        <br><br>
                     ...
                     <br><br>
                        ...
                        <div class="comment">
                            ...
                            <div class="com_div3" align="center">
                                <textarea name="" id="comment" cols="120" rows="5" name="com" placeholder="댓글을 입력해주세요." style="resize:none; outline:none; border:none;" onkeypress="onChange();" class="txtArea" maxlength="500"></textarea>
                    						...
                    						result += "<tr class='comm'>"
                                                ...
                                                +       "<td width='80'>" + list[i].regDate + "</td>"
                                                        ...
                                                        +            "<td><input type='button' value='삭제' class='btn-post' style='float: right' onclick='deleteReply("+ list[i].replyNo +")'></td>"
                                                   		<% } %>
                                                + "</tr>"
                                                + "<tr class='nested_reply_container' align='center' style='display:none;'>"+
                                ...
                                <div class="modal" id="deleteForm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <b>게시글을 삭제하시겠습니까?<br>
                                                <form action="<%= contextPath %>/thingsDelete.po?pno=<%= p.getPostNo() %>" method="post">
