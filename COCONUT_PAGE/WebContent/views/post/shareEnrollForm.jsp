...
<body>
    <div class="wrap">
        ...
        <div class="container">
            ...
            <div class="main">
                <form action="<%=contextPath %>/insert.share" method="post" enctype="multipart/form-data">
                
                <input type="hidden" name="empNo" value="<%=e.getEmpNo()%>">
                    <div id="write_post">
                        <div id="write_post_title">
                        
                            <input type="text" id="write_post_title_input" name="shareTitle" placeholder="제목을 입력하세요." maxlength="50" required>
                        
                        </div>
                                                
                        <div id="write_post_content" >
                        
                                <textarea name="shareContent" id="post_content_input" placeholder="내용을 입력하세요." maxlength="1000" required style="resize:none;"></textarea>
                                ...
                                <tr> <!-- 이미지 미리보기 영역 -->
                                    ...
                                    <div align="center">
                                        <td colspan="3" align="center">
                                            <img id="titleImg" width="450px" height="360px">
                                        </td>
                                    </div>
                                </tr>
                                <tr>
