		...
		<div class="container">
			<%@ include file="../common/sidebar.jsp" %>
				...
				<div class="main">
					...
					<form id="post1Enroll-form" action="<%=contextPath %>/wagleInsert.po" method="post" enctype="multipart/form-data">
						<!-- 제목/내용/첨부파일입력받고 작성자사원번호 hidden 으로 넘김  -->
						<input type="hidden" name="empNo" value="<%= e.getEmpNo() %>">
						<div class="write_form">
							<div class="write_title"> <!--제목입력-->
								<input type="text" name="title" autocomplete="off" required placeholder="제목을 입력하세요." class="title_input" style="font-weight: 400;">
							</div>

                            <div class="content_area">
                                <textarea id="contentText" name="content" style="resize: none;" required placeholder="내용을 입력하세요."></textarea>
                            </div>
